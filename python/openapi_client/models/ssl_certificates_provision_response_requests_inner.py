...
class SSLCertificatesProvisionResponseRequestsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["log", "result", "domains"]

    @field_validator('result')
    def result_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['installed', 'error', 'skipped']):
            raise ValueError("must be one of enum values ('installed', 'error', 'skipped')")
        return value

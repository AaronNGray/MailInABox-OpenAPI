...
class SSLStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    can_provision: List[StrictStr]
    status: List[SSLStatus]
    __properties: ClassVar[List[str]] = ["can_provision", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "can_provision": obj.get("can_provision"),
            "status": [SSLStatus.from_dict(_item) for _item in obj["status"]] if obj.get("status") is not None else None
        })
        return _obj

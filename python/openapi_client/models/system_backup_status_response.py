...
class SystemBackupStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    backups: Optional[List[SystemBackupStatus]] = None
    unmatched_file_size: StrictInt
    error: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["backups", "unmatched_file_size", "error"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "backups": [SystemBackupStatus.from_dict(_item) for _item in obj["backups"]] if obj.get("backups") is not None else None,
            "unmatched_file_size": obj.get("unmatched_file_size"),
            "error": obj.get("error")
        })
        return _obj

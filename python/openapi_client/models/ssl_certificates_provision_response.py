...
class SSLCertificatesProvisionResponse(BaseModel):
    """
    SSL certificates provision response.
    """ # noqa: E501
    requests: List[SSLCertificatesProvisionResponseRequestsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "requests": [SSLCertificatesProvisionResponseRequestsInner.from_dict(_item) for _item in obj["requests"]] if obj.get("requests") is not None else None
        })
        return _obj

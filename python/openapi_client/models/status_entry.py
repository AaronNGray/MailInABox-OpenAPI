...
class StatusEntry(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "text", "extra"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "text": obj.get("text"),
            "extra": [StatusEntryExtra.from_dict(_item) for _item in obj["extra"]] if obj.get("extra") is not None else None
        })
        return _obj

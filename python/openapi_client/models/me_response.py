...
class MeResponse(BaseModel):
    ...
    email: Optional[StrictStr] = Field(default=None, description="Email format.")
    privileges: Optional[List[MailUserPrivilege]] = None
    reason: Optional[StrictStr] = None
    status: MeAuthStatus
    __properties: ClassVar[List[str]] = ["api_key", "email", "privileges", "reason", "status"]

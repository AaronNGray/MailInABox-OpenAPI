...
class MailAliasByDomain(BaseModel):
    """
    Mail aliases by domain.
    """ # noqa: E501
    domain: StrictStr = Field(description="Hostname format.")
    aliases: List[MailAlias]
    __properties: ClassVar[List[str]] = ["domain", "aliases"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "aliases": [MailAlias.from_dict(_item) for _item in obj["aliases"]] if obj.get("aliases") is not None else None
        })
        return _obj

...
class MailUserByDomain(BaseModel):
    """
    Mail users by domain.
    """ # noqa: E501
    domain: StrictStr = Field(description="Hostname format.")
    users: List[MailUser]
    __properties: ClassVar[List[str]] = ["domain", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [MailUser.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj

...
class DNSDumpDomainRecord(BaseModel):
    """
    Domain DNS record details.
    """ # noqa: E501
    explanation: StrictStr
    qname: StrictStr = Field(description="Hostname format.")
    rtype: Optional[DNSRecordType] = None
    value: StrictStr
    __properties: ClassVar[List[str]] = ["explanation", "qname", "rtype", "value"]

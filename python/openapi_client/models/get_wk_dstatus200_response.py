...
class GetWKDstatus200Response(BaseModel):
    """
    GetWKDstatus200Response
    """ # noqa: E501
    keys: List[PgpKey]
    wkd: Dict[str, Any]
    __properties: ClassVar[List[str]] = ["keys", "wkd"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [PgpKey.from_dict(_item) for _item in obj["keys"]] if obj.get("keys") is not None else None,
            "wkd": obj.get("wkd")
        })
        return _obj

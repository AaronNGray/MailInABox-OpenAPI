...
class WKDApi:
    ...
    def get_wk_dstatus(
        ...
        _param = self._get_wk_dstatus_serialize(
    ...
    @validate_call
    def get_wk_dstatus_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetWKDstatus200Response]:
        """Get WKD status
    ...
    @validate_call
    def get_wk_dstatus_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],

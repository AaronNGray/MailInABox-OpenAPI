...
class TestSSLCertificatesProvisionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SSLCertificatesProvisionResponse:
        """Test SSLCertificatesProvisionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SSLCertificatesProvisionResponse`
        """
        model = SSLCertificatesProvisionResponse()
        if include_optional:
            return SSLCertificatesProvisionResponse(
                requests = [
                    openapi_client.models.ssl_certificates_provision_response_requests_inner.SSLCertificatesProvisionResponse_requests_inner(

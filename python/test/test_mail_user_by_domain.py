...
class TestMailUserByDomain(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MailUserByDomain:
        """Test MailUserByDomain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MailUserByDomain`
        """
        model = MailUserByDomain()
        if include_optional:
            return MailUserByDomain(
                domain = 'example.com',
                users = [
                    openapi_client.models.mail_user.MailUser(

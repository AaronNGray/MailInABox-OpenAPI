...
class TestSSLStatusResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SSLStatusResponse:
        """Test SSLStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SSLStatusResponse`
        """
        model = SSLStatusResponse()
        if include_optional:
            return SSLStatusResponse(
                ...
                status = [
                    openapi_client.models.ssl_status.SSLStatus(
                        domain = 'example.com', 
                        status = 'success', 

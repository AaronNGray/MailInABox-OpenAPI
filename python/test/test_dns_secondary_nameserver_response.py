...
class TestDNSSecondaryNameserverResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DNSSecondaryNameserverResponse:
        """Test DNSSecondaryNameserverResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DNSSecondaryNameserverResponse`
        """
        model = DNSSecondaryNameserverResponse()
        if include_optional:
